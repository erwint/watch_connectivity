...
abstract class WatchConnectivityBase {
  ...
  Stream<Map<String, dynamic>> get contextStream =>
      contextStreamController.stream;
  ...
  Future handle(MethodCall call) async {
    switch (call.method) {
      case 'didReceiveMessage':
        messageStreamController.add(Map<String, dynamic>.from(call.arguments));
        break;
      case 'didReceiveApplicationContext':
        contextStreamController.add(Map<String, dynamic>.from(call.arguments));
        break;
      default:
